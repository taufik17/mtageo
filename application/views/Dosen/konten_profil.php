		...
		<section class="content">
           ...
           ?>
												<img class="profile-user-img img-responsive img-circle" src="<?php base_url() ?>assets/foto_profil_dosen/<?php echo $nama->foto; ?>" alt="User profile picture">
						...
						<div class="col-md-9">
								<div class="nav-tabs-custom">
										<ul class="nav nav-tabs">
												...
												<li class="active"><a href="#settings" data-toggle="tab">Ubah Data</a></li>
