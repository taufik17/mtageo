<section class="content">
	<?php
	if ($status_daftar_seminar_ta == 0) {
		?>
		<div class="box box-primary">
			<div class="box-header">
				<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
				<h3 class="box-title text-center">Pengisian Form Pendaftaran Seminar TA1</h3>
			</div>
			...
			<div class="row bs-wizard" style="border-bottom:0;">
				<div class="col-xs-4 bs-wizard-step active">
					...
					<div class="bs-wizard-info text-center">Pengisian Form Pendaftaran Seminar TA1</div>
				</div>
			...
			<?php } ?>
			<form action="<?php base_url() ?>Daftar_Seminar_TA1/upload_data_seminar_ta" method="POST" enctype="multipart/form-data">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="ruangan" id="exampleInputEmail1" placeholder="Ruangan Seminar">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="file" name="draftta" class="dropify" data-height="80" required>
	...
	<?php }
		...
		<table class="table">
			...
			<tr>
				...
				<form method="post" action="<?php base_url() ?>Daftar_Seminar_TA1/update_data_seminar_ta" enctype="multipart/form-data">
				<div class="box-body">
					<p>&nbsp</p>
					<?php
					if ($row->st_penguji1 == 2) {
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">Penguji 1</label>
							<div class="col-sm-10">
								<input type="text" name="penguji1" class="form-control" placeholder="Penguji 1" required value="<?php echo $row->penguji1_seminar_ta; ?>">
					...
					elseif ($row->st_penguji1 == 1) {
						...
						<input type="text" name="penguji1" value="<?php echo $row->penguji1_seminar_ta; ?>" hidden>
					<?php }
					else {
						?>
						<input type="text" name="st_penguji1" value="0" hidden>
					...
					if ($row->st_penguji2 == 2) {
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">Penguji 2</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="penguji2" placeholder="Penguji 2" required value="<?php echo $row->penguji2_seminar_ta; ?>">
					...
					elseif ($row->st_penguji2 == 1) {
						...
						<input type="text" name="penguji2" value="<?php echo $row->penguji2_seminar_ta; ?>" hidden>
					<?php }
					else {
						?>
						<input type="text" name="st_penguji2" value="0" hidden>
					...
					elseif ($row->st_tanggal == 1) {
						...
						<input type="text" name="tgl_seminar" value="<?php echo $row->tgl_seminar_ta; ?>" hidden>
					<?php }
					else {
						?>
						<input type="text" name="st_tanggal" value="0" hidden>
					...
					elseif ($row->st_waktu == 1) {
						...
						<input type="text" name="wkt_seminar" value="<?php echo $row->waktu_seminar_ta; ?>" hidden>
					<?php }
					else {
						?>
						<input type="text" name="st_waktu" value="0" hidden>
					...
					<?php
					if ($row->st_draft_ta == 2) {
						?>
						<div class="form-group">
							<label for="exampleInputFile" class="col-sm-2 control-label">File Draft TA1</label>
							<div class="col-sm-10">
								<input type="file" name="draftta" class="dropify" data-height="80" required>
								<input type="text" name="st_draft_ta" value="0" hidden>
								<p class="help-block">File Max 10 Mb</p>
							</div>
						</div>
					<?php }
					elseif ($row->st_draft_ta == 1) {
						?>
						<input type="text" name="st_draft_ta" value="1" hidden>
						<input type="text" name="draftta" value="<?php echo $row->Draft_TA; ?>" hidden>
					<?php }
					else {
						?>
						<input type="text" name="st_draft_ta" value="0" hidden>
			...
			elseif ($row->status_ta == 5) {
				?>
				<?php
				if ($row->st_waktu == 0 && $row->st_tanggal == 0 && $row->st_penguji1 == 0 && $row->st_penguji2 == 0 && $row->st_ruangan == 0 && $row->st_draft_ta == 0 ) {
					?>
		...
		<?php }
			...
			?>
			<div class="box-footer">
				<a href="<?php base_url() ?>Daftar_Seminar_TA1/PermohonanUlang" class="btn btn-primary pull-right"><i class="fa fa-repeat"></i>&nbsp&nbspPermohonan Ulang</a>
			</div>
		<?php } ?>
	</div>
				</div>
			<?php }
			elseif ($row->status_ta >= 6){
				?>
				<div class="alert alert-success alert-dismissible fade in">
					<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
					<h4><i class="icon fa fa-info-circle"></i> info</h4>
					Selamat Pendaftaran Seminar TA1 telah disetujui.
				</div>
				<div class="box box-primary">
					<div class="box-header">
						<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
