<section class="content">
	...
	<div class="box-header">
		<a href="<?php echo base_url(); ?>K_seminar_hasil"><i class="fa fa-fw fa-arrow-circle-left fa-lg">&nbspKembali</i></a>
	</div>
	...
	<div class="box-body">
		<div class="row">
				<div class="col-md-12">
	<form action="<?php echo base_url(); ?>K_seminar_hasil/updatestatuspermohonan" method="post">
		...
		<table width="100%" class="table table-striped table-bordered table-hover dataTable" id="dataTables-example">
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<?php }
							...
							<label class="radio-inline">
								<input type="text" class="form-control" name="tgl_seminar" id="datepicker" placeholder="Isi jika tanggal tidak sesuai" value="<?php echo $row->tgl_seminar_hasil; ?>">
				...
				<tr>
					...
					<td>
						...
						<?php }
							...
							<label class="radio-inline">
								<input type="text" name="wkt_seminar" class="form-control timepicker" placeholder="Isi jika waktu tidak sesuai" value="<?php echo $row->waktu_seminar_hasil; ?>">
				...
				<tr>
					<td>Draft TA 2</td>
					<td><a  href="<?php echo base_url()?>assets/DataSeminarHasil/<?php echo $row->Draft_TA2; ?>" class="btn btn-primary btn-sm" target="_blank">Draft TA 2</a></td>
					...
					<td>
						<?php
						if ($row->st_draft_ta2 == 1) {
							?>
							<label class="radio-inline">
								<input type="radio" name="st_draft_ta2" value="1" checked>
								<font color="green">Disetujui</font>
							</label>
						<?php }
						elseif ($row->st_draft_ta2 == 2) {
							?>
							<label class="radio-inline">
								<input type="radio" name="st_draft_ta2" value="2" checked>
								<font color="red">Tidak Disetujui</font>
							</label>
						<?php }
						else {
							?>
							<label class="radio-inline">
								<input type="radio" name="st_draft_ta2" value="1" required>Valid
							</label>
							<label class="radio-inline">
								<input type="radio" name="st_draft_ta2" value="2">Tidak Valid
							</label>
						<?php } ?>
					</td>
				</tr>
